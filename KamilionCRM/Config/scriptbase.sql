...
CREATE TABLE EquipoStandar ( eq_equipo VARCHAR(100) NOT NULL , eq_marca VARCHAR(100) NOT NULL , primary key(eq_equipo,eq_marca))



ALTER TABLE `division_politica` CHANGE `divp_if` `divp_id` INT(11) NOT NULL;
