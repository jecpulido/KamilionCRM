<div class="box-principal">
    <fieldset class="panelregistro">
        <h2 class="page-header">EDITAR USUARIO | <?php echo $datos['persona']['per_nombre']." ".$datos['persona']['per_apellidos'] ?> |<a href="<?php echo URL;?>admin/listarUsuario" class="btn btn-primary"><i class="fa fa-users"></i> Ver listado</a></h2>
                ...
                <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data" >
                    <div class="" >
                        ...
                        <div class="form-registro form-group col-md-6">
                            ...
                            <input class="form-control" name="Personal_per_codigo" type="text" value="<?php echo $datos['usuario']['Personal_per_codigo']; ?>" maxlength="5" readonly required>
                        </div>
                        <!-- Usuario-->
                        <div class="form-registro form-group col-md-6">
                            <label for="usu_id" class="control-label">Usuario</label>
                            <input class="form-control" name="usu_id" type="text" value="<?php echo $datos['usuario']['usu_id']; ?>" required>
                        </div>
                            ...
                            <select  name="Perfil_perf_id" class="form-control" required>
                                <?php foreach ($datos['perfil'] as $row){ ?>
                                    <?php if($row['perf_id'] == $datos['usuario']['Perfil_perf_id']){?>
                                        <option selected value="<?php echo $row['perf_id']; ?>"><?php echo $row['perf_descripcion']; ?></option>
                                    <?php }else{ ?>
                        ...
                        <div class="form-registro form-group col-md-6">
                            ...
                            <input class="form-control" name="usu_jefe" type="text" value="<?php echo $datos['usuario']['usu_jefe']; ?>" required>
                        </div>
